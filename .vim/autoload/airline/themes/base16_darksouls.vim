...
let s:scheme_slug = substitute("darksouls", "-", "_", "g")
...
let s:gui03 = "#9f926f"  " comments
let s:gui04 = "#9f926f"  " statusline ???
let s:gui05 = "#F2F0D5"  " text + cursor
let s:gui06 = "#ff0000"  " default: ffffff, idk what it does tho
let s:gui07 = "#f0ce48"  " Airline: File name when modified
